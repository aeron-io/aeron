...
* **Breaking** **[Logging]** The aeron-agent jar has been removed so setting -javaagent:<file name> is not longer required. The existing configuration options are still supported.
