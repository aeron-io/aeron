...
* [Driver/C] Support using CGroups based cpusets when setting thread affinity. Validate that the cpuset has a sane configuration.
* [Driver/C] Support setting thread affinity on the async agent (used for name resolution, etc.)
* **[Java]** Upgrade to `Gradle` 9.5.1.
