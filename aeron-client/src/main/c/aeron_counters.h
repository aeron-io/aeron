...
#define AERON_SYSTEM_COUNTER_ID_NATIVE_RESOURCE_AGENT_PROXY_FAILS (45)
...
#define AERON_COUNTER_SEQUENCER_REPLAY_SERVICE_MAX_CYCLE_TIME_COUNTER_TYPE_ID (545)

#define AERON_COUNTER_SEQUENCER_REPLAY_SERVICE_CYCLE_TIME_THRESHOLD_EXCEEDED_TYPE_ID (546)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_MAX_CYCLE_TIME_COUNTER_TYPE_ID (547)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_CYCLE_TIME_THRESHOLD_EXCEEDED_TYPE_ID (548)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_ACTIVE_SESSIONS_COUNTER_TYPE_ID (549)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_ACTIVE_ADMIN_OPERATIONS_COUNTER_TYPE_ID (550)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_QUEUED_OPERATIONS_TYPE_ID (551)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_STORE_ERROR_COUNT_TYPE_ID (552)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_LOAD_ERROR_COUNT_TYPE_ID (553)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_LIST_ERROR_COUNT_TYPE_ID (554)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_ADMIN_ERROR_COUNT_TYPE_ID (555)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_STORAGE_MODULE_ERROR_COUNT_TYPE_ID (556)

#define AERON_COUNTER_SEQUENCER_APPLICATION_SNAPSHOT_LAST_STORED_SEQUENCE_INDEX_TYPE_ID (557)

#define AERON_COUNTER_SEQUENCER_APPLICATION_SNAPSHOT_LAST_LOADED_SEQUENCE_INDEX_TYPE_ID (558)

#define AERON_COUNTER_SEQUENCER_APPLICATION_SNAPSHOT_ACTIVITY_STATE_TYPE_ID (559)

#define AERON_COUNTER_SEQUENCER_APPLICATION_SNAPSHOT_LOAD_ERROR_COUNT_TYPE_ID (560)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_TOTAL_STORE_OPERATIONS_COUNTER_TYPE_ID (561)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_TOTAL_LOAD_OPERATIONS_COUNTER_TYPE_ID (562)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_TOTAL_LIST_OPERATIONS_COUNTER_TYPE_ID (563)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_TOTAL_FIND_LATEST_OPERATIONS_COUNTER_TYPE_ID (564)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_TOTAL_ADMIN_OPERATIONS_COUNTER_TYPE_ID (565)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_ACTIVE_LIST_OPERATIONS_COUNTER_TYPE_ID (566)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_ACTIVE_FIND_LATEST_OPERATIONS_COUNTER_TYPE_ID (567)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_ACTIVE_DESCRIBE_OPERATIONS_COUNTER_TYPE_ID (568)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_TOTAL_DESCRIBE_OPERATIONS_COUNTER_TYPE_ID (569)

#define AERON_COUNTER_SEQUENCER_SNAPSHOT_SERVICE_DESCRIBE_ERROR_COUNT_TYPE_ID (570)
