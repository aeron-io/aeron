...
#define AERON_COUNTER_EF_VI_BIND_ADDRESS_TYPE_ID (50)
...
#define AERON_COUNTER_VMA_RX_ZERO_COPY_BYTES (62)
#define AERON_COUNTER_VMA_RX_DATA_COPY_BYTES (63)
...
#define AERON_COUNTER_DPDK_BIND_ADDRESS_TYPE_ID (75)
