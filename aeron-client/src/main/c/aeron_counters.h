...
#define AERON_COUNTER_ARCHIVE_RECORDING_SESSION_COUNT_TYPE_ID (111)
...
#define AERON_COUNTER_CLUSTER_STANDBY_SNAPSHOT_COUNTER_TYPE_ID (232)

#define AERON_COUNTER_NODE_CONTROL_TOGGLE_TYPE_ID (233)

#define AERON_COUNTER_CLUSTER_TOTAL_MAX_SNAPSHOT_DURATION_TYPE_ID (234)

#define AERON_COUNTER_CLUSTER_TOTAL_SNAPSHOT_DURATION_THRESHOLD_EXCEEDED_TYPE_ID (235)

#define AERON_COUNTER_CLUSTERED_SERVICE_MAX_SNAPSHOT_DURATION_TYPE_ID (236)
...
#define AERON_COUNTER_CLUSTER_BACKUP_SNAPSHOT_RETRIEVE_COUNT_TYPE_ID (240)

#define AERON_COUNTER_CLUSTER_SESSION_TYPE_ID (241)
