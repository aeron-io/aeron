 ...
 * encoder class (unlike {@link EventLoggerProcessor}, which this processor otherwise mirrors in structure).
 * The generated class is named {@code <Interface>CborImpl} and is emitted alongside (not instead of) the
 * {@code <Interface>Impl} class generated by {@link EventLoggerProcessor}.
 * <p>
