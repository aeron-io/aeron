...
public final class CDriverConfiguration
{
    ...
    /**
     * Initialisation arguments passed to the C driver's idle strategy for the sender thread.
    ...
    /**
     * Initialisation arguments passed to the C driver's idle strategy for the conductor thread.
    ...
    /**
     * Initialisation arguments passed to the C driver's idle strategy for the receiver thread.
    ...
    /**
     * Initialisation arguments passed to the C driver's idle strategy for the shared network thread
    ...
    /**
     * Initialisation arguments passed to the C driver's idle strategy for the shared thread
