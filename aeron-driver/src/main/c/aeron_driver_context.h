...
typedef struct aeron_driver_context_stct
{
    ...
    uint64_t resolver_neighbor_timeout_ns;                          /* aeron.resolver.neighbor.timeout.ns */
    uint64_t resolver_self_resolution_interval_ns;                  /* aeron.resolver.self.resolution.interval */
    uint64_t resolver_neighbor_resolution_interval_ns;              /* aeron.resolver.neighbor.resolution.interval */
    uint64_t resolver_bootstrap_neighbor_resolution_interval_ns;    /* aeron.resolver.bootstrap.neighbor.resolution.interval */
