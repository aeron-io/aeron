...
#define AERON_AGENT_RUNNER_NATIVE_RESOURCE_AGENT 1
#define AERON_AGENT_RUNNER_RECEIVER 2
#define AERON_AGENT_RUNNER_SENDER 3
#define AERON_AGENT_RUNNER_SHARED_NETWORK 2
#define AERON_AGENT_RUNNER_SHARED 0
#define AERON_AGENT_RUNNER_MAX 4
