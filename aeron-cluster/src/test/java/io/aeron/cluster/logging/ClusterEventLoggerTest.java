...
import static io.aeron.cluster.logging.ClusterEventCode.APPEND_POSITION;
...
import static io.aeron.cluster.logging.ClusterEventCode.CANVASS_POSITION;
import static io.aeron.cluster.logging.ClusterEventCode.CATCHUP_POSITION;
import static io.aeron.cluster.logging.ClusterEventCode.CLUSTER_SESSION_STATE_CHANGE;
import static io.aeron.cluster.logging.ClusterEventCode.COMMIT_POSITION;
...
import static io.aeron.cluster.logging.ClusterEventCode.NEW_LEADERSHIP_TERM;
import static io.aeron.cluster.logging.ClusterEventCode.REPLAY_NEW_LEADERSHIP_TERM;
import static io.aeron.cluster.logging.ClusterEventCode.REPLICATION_ENDED;
import static io.aeron.cluster.logging.ClusterEventCode.REQUEST_VOTE;
import static io.aeron.cluster.logging.ClusterEventCode.SERVICE_ACK;
import static io.aeron.cluster.logging.ClusterEventCode.SNAPSHOT_ENTRY_INVALIDATION;
import static io.aeron.cluster.logging.ClusterEventCode.STANDBY_SNAPSHOT_NOTIFICATION;
import static io.aeron.cluster.logging.ClusterEventCode.STATE_CHANGE;
import static io.aeron.cluster.logging.ClusterEventCode.STOP_CATCHUP;
import static io.aeron.cluster.logging.ClusterEventCode.TERMINATION_ACK;
import static io.aeron.cluster.logging.ClusterEventCode.TERMINATION_POSITION;
import static io.aeron.cluster.logging.ClusterEventCode.TRUNCATE_LOG_ENTRY;
import static io.aeron.cluster.logging.ClusterEventCode.VOTE;
import static io.aeron.cluster.logging.ClusterEventEncoder.MAX_REASON_LENGTH;
import static io.aeron.cluster.logging.ClusterEventEncoder.canvassPositionLength;
import static io.aeron.cluster.logging.ClusterEventEncoder.clusterSessionStateChangeLength;
import static io.aeron.cluster.logging.ClusterEventEncoder.electionStateChangeLength;
import static io.aeron.cluster.logging.ClusterEventEncoder.newElectionLength;
import static io.aeron.cluster.logging.ClusterEventEncoder.newLeaderShipTermLength;
import static io.aeron.cluster.logging.ClusterEventEncoder.replayNewLeadershipTermEventLength;
import static io.aeron.cluster.logging.ClusterEventEncoder.replicationEndedLength;
import static io.aeron.cluster.logging.ClusterEventEncoder.serviceAckLength;
import static io.aeron.cluster.logging.ClusterEventEncoder.snapshotEntryInvalidationLength;
import static io.aeron.cluster.logging.ClusterEventEncoder.standbySnapshotNotificationLength;
import static io.aeron.cluster.logging.ClusterEventEncoder.terminationAckLength;
import static io.aeron.cluster.logging.ClusterEventEncoder.terminationPositionLength;
...
import static io.aeron.logging.CommonEventEncoder.enumName;
