...
public final class ClusterMember
{
    ...
    public void reset()
    {
        ...
        // Clearing the term is what invalidates the echo: hasQuorumConfirmedSince only counts a counter recorded
        // against the current term, so confirmationCounter itself is left alone rather than needing a reset value.
